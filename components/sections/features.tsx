...
export default function FeatureSection() {
  return (
    <section id="features" className="relative py-2 md:py-20 px-10 mx-5 rounded-3xl bg-gray-900 text-gray-200">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="flex justify-center mt-8">
          <Button className="bg-white text-gray-900 hover:bg-gray-100 font-medium py-2 px-4 rounded-lg shadow">
            Learn More
          </Button>
        </div>
      </div>
